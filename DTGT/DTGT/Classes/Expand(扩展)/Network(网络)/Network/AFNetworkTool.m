...
/*
 一.网络的请求流程
 1.构造Request   NSURLRequest
 2.构造连接类     AFHTTPRequestOperation
 3.发送异步请求
 4.监听数据传输的事件
...
+ (void)JSONDataWithUrl:(NSString *)url success:(void (^)(id json))success fail:(void (^)())fail;
{
    ...
    AFHTTPRequestOperation *requestOperation = [manager GET:url parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        if (success) {
